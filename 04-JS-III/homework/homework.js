...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var numerosPromediados = 0;
  for(var i = 0; i < resultadosTest.length; i++){
    numerosPromediados = numerosPromediados + resultadosTest[i]; 
  }
  return numerosPromediados / resultadosTest.length;
}
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var numerosRevisados = 0;
  for(var i = 0; i < numeros.length; i++){
    if(numeros[i] > numerosRevisados){
       numerosRevisados = numeros[i];
    }   
  }
  return numerosRevisados;
}
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  var numeroInicial = n.toString();
  if(numeroInicial[0] === "9"){
    return true;
  }else{
    return false;
  } 
